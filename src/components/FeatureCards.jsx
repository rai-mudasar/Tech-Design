  ...
  return (
    <div className="h-auto w-full bg-stone-200 dark:bg-[#0F1524] text-white dark:text-white pb-20 flex flex-col">
      <div className=" mt-20 text-center">
        <p className="text-2xl font-bold text-[#2E918A] uppercase">
          Featured Courses
        </p>
        <p className="text-4xl font-bold mt-3 uppercase text-black dark:text-white">
          Learn With The Best
        </p>
      </div>
            ...
            <div key={course.id} className="flex justify-center">
              <BackgroundGradient className="h-full flex flex-col bg-zinc-900 dark:bg-zinc-900 rounded-[22px] overflow-hidden max-w-sm flex-grow">
                <div className="p-4 sm:p-6 flex flex-col text-center items-center flex-grow">
                  <p className="text-lg sm:text-xl mt-4 mb-2 text-black dark:text-neutral-200 font-semibold md:font-bold">
                    {course.title}
                  </p>
                  <p className="mb-2 text-sm text-neutral-600 dark:text-neutral-400 flex-grow">
                    {course.detail}
                  </p>
                  <Link href="#" className="">
                    Learn More
      ...
      <div className="mt-20 text-center">
          <Link href={"#"} className="px-6 py-4 border border-neutral-600 text-neutral-700 bg-white hover:bg-gray-200 transition duration-200 rounded">
            View All Courses
          </Link>
      </div>
    </div>
